...
enum WalletFeature
{
    FEATURE_BASE = 70000, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 70000, // wallet encryption
    FEATURE_COMPRPUBKEY = 70001, // compressed public keys
