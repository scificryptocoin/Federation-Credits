...
const QString BITCOIN_IPC_PREFIX("federationcredit:");
...
{
    QString name("FederationCreditQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click federationcredit: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start federationcredit: click-to-pay handler");
    else
...
{
    // clicking on federationcredit: URLs creates FileOpen events on the Mac:
