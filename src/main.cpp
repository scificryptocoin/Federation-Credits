...
// Copyright (c) 2014 The FederationCredit developers
...
uint256 hashGenesisBlock("0x0000004458dc5b288b456cd0123efe7c9509a905d4c7cef44f3104cadcf414c1");
static const unsigned int timeGenesisBlock = 1390407606;
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 40);
static CBigNum bnProofOfWorkLimitGenesis(~uint256(0) >> 24);
...
static const int64 nBlockRewardCoin = 50 * COIN;
static const int64 nSuperBlockCoin = 8000000 * COIN;
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "BTC 28188__21ddd91ae48ec50cfc997326";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = nBlockRewardCoin;
       ...
       // printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        block.print();
        assert(block.hashMerkleRoot == uint256("0x74d19561f56ecf84300cf5f8f6cb430bf7d6174da4b5385ec4caf2e38b79f481"));
...
{
    printf("FederationCreditMiner started\n");
...
//            unsigned int nNonceFound;
    ...
    {
        printf("FederationCreditMiner terminated\n");
        throw;
    }
}
